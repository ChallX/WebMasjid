...
<header>
  ...
  <section class="main">
    <div class="balapi">
   <p class="mainp">Masjid Besar SMK Wikrama Bogor</p>
   <h1 class="mainh1">Mari <span>Tingkatkan</span> <br> <span>Keimanan </span>Masyarakat <br> SMK Wikrama Bogor </h1>
...
<button class="butsho"> <a class="butlink" href="input.php">Beri Bantuan Shodaqoh</a> </button>
</section>
...
<section class="banner">
	<div class="slider-wrapper">
		<div class="slider">
			<img id="slide-1" src="masjidwik1.jpg" />
			<img id="slide-2" src="masjidwik2.jpg" />
			<img id="slide-3" src="masjidwik3.jpg" />
...
<section class="gallwak">
  ...
  <img class="gallmas3" src="masjidwik7.jpg" alt="">
  <img class="gallmas4" src="masjidwik8.jpg" alt="">
  <img class="gallmas5" src="masjidwik9.jpg" alt="">
  <img class="gallmas6" src="masjidwik10.jpg" alt="">
